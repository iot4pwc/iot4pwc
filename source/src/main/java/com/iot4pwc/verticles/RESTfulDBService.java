...
/**
 * Http request handler for data retrieval and actuation excecution
 * 
 * Request end point:
 ...
 * POST /actuate  {"app_id":"1", "sensor_id":"1", "action_id":"3"}}
 * 
 * Author: Shuang Li
 */
public class RESTfulDBService extends AbstractVerticle {
	...
	/**
	 * Handles the request to get historical data given topic and time range
	 * @param http request object
	 * @return this method respond directly to request
	 * */
	...
	/**
	 * Handles the request to get basic information for all installed sensors
	 * @param http request object
	 * @return this method respond directly to request
	 * */
	...
	/**
	 * Handles the request to get all sensors installed in a given location
	 * @param http request object
	 * @return this method respond directly to request
	 * */
	...
	/**
	 * Handles the request to process actuation command on given actuator
	 * @param http request object
	 * @return this method respond directly to request
	 * */
